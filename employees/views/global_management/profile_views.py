...
def update_employee(request, employee_id):
    try:
        ...
        kyc_details = {
            ...
            'uanNumber': data.get('kyc_unaNumber', data.get('kyc_uanNumber', existing_kyc.get('uanNumber', ''))),
        ...
        salary_details = {
            'netSalary': data.get('salary_netSalary', existing_salary.get('netSalary', '')),
            'grossSalary': data.get('salary_grossSalary', existing_salary.get('grossSalary', '')),
            'ctc': data.get('salary_ctc', existing_salary.get('ctc', '')),
        }
